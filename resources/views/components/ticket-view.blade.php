<div x-data="ticketFunc()">
    <div class="mt-10 flex justify-center">
        <div class="relative max-w-md px-6 py-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100">
            <span x-text='ticket.status' class="absolute -top-2 -end-2 text-xs font-medium me-2 px-2.5 py-0.5 rounded"
                :class="{
